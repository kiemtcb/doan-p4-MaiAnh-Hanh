...
/**
 * Implementation of a pipeline interpreter for the program.
 */
public final class PipelineInterpreterImpl
    ...
    private static final PiMatchFieldId IPV4_SOURCE =
            PiMatchFieldId.of(HDR + DOT + IPV4 + DOT + "src_addr");
    private static final PiMatchFieldId IPV4_DESTIN =
            PiMatchFieldId.of(HDR + DOT + IPV4 + DOT + "dst_addr");
private static final PiMatchFieldId IPV4_PROTOCOL =
            PiMatchFieldId.of(HDR + DOT + IPV4 + DOT + "protocol");
    private static final PiMatchFieldId TCP_SOURCE =
            PiMatchFieldId.of(HDR + DOT + TCP + DOT + "src_port");
    private static final PiMatchFieldId TCP_DESTIN =
            PiMatchFieldId.of(HDR + DOT + TCP + DOT + "dst_port");
    private static final PiMatchFieldId UDP_SOURCE =
            PiMatchFieldId.of(HDR + DOT + UDP + DOT + "srcPort");
    private static final PiMatchFieldId UDP_DESTIN =
    ...
    private static final Map<Criterion.Type, PiMatchFieldId> CRITERION_MAP =
            ImmutableMap.<Criterion.Type, PiMatchFieldId>builder()
                    ...
                    .put(Criterion.Type.IPV4_SRC, IPV4_SOURCE)
                    .put(Criterion.Type.IPV4_DST, IPV4_DESTIN)
                    .put(Criterion.Type.IP_PROTO, IPV4_PROTOCOL)
                    .put(Criterion.Type.TCP_SRC, TCP_SOURCE)
                    .put(Criterion.Type.TCP_DST, TCP_DESTIN)
                    .put(Criterion.Type.UDP_SRC, UDP_SOURCE)
                    .put(Criterion.Type.UDP_DST, UDP_DESTIN)
                    .build();
    ...
    public PiAction mapTreatment(TrafficTreatment treatment, PiTableId piTableId)
        ...
        // int soluong = treatment.allInstructions().size();
